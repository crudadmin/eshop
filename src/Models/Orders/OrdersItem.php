...
class OrdersItem extends AdminModel implements UsesIdentifier, DiscountSupport
{
    ...
    public function fields()
    {
        return [
            ...
            Group::fields([
                'default_price' => 'name:Pôvodna cena bez DPH|invisible|type:decimal|decimal_length:'.config('admineshop.prices.decimals_places').'|title:Cena produktu v čase objednania.|disabled',
                'price' => 'name:Cena/j bez DPH|type:decimal|decimal_length:'.config('admineshop.prices.decimals_places').'|required_if:manual_price,1|disabledIf:manual_price,0',
                'vat' => 'name:DPH %|type:select|default:'.Store::getDefaultVat().'|required_if:manual_price,1|disabledIf:manual_price,0',
                'price_vat' => 'name:Cena/j s DPH|type:decimal|required_if:manual_price,1|decimal_length:'.config('admineshop.prices.decimals_places').'|disabledIf:manual_price,0',
