    ...
    public function fields($row)
    {
        return [
            ...
            'Vyberte jednu alebo viac zliav' => Group::half([
                ...
                'discount_price' => 'name:Zľava v €|title:Z celkovej ceny objednávky, bez DPH.|min:0|type:decimal|hideFieldIfNot:discount_percentage,|required_without_all:discount_percent,free_delivery',
