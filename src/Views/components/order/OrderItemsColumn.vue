<template>
<div @mouseenter="loadProducts" ref="element" data-template='<div class="tooltip tooltip-products" role="tooltip"><div class="arrow"></div><div class="tooltip-inner"></div></div>' data-toggle="tooltip" data-bs-html="true" :title="products" :key="loaded ? 1 : 0">
    {{ valueMutated }}
</div>
</template>
